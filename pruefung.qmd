...
Für jede Aufgabe lassen sich verschiedene Lösungswege finden. Es ist nicht nötig, dass Ihre Lösung exakt der Musterlösung entspricht. Wichtig ist, dass Sie die Aufgabe lösen und Ihre Lösung nachvollziehbar dokumentieren.
Treffen Sie Annahmen, wenn die Aufgabenstellung dies erfordert, und dokumentieren Sie diese Annahmen in Ihrer Lösung.
...
d.h. die Lösung muss bis zum jeweiligen Abgabetermin eingereicht werden. Der *späteste* Abgabetermin ist der Vorabend des nächsten Unterrichtstermin - um 23.59.00. Beispiel: Der Unterricht findet wöchentlich am Dienstag statt. Die Challenge wird am  Dienstag diese Woche besprochen und muss bis Montagabend der nächsten Woche eingereicht werden. Ausnahmen von dieser Regel (z.B. bei Feiertagen) werden rechtzeitig bekannt gegeben; s. auch den Modulverlaufsplan.
